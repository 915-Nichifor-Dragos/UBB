...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String, Value> symTbl, MyIList<Value> outTbl,
                    MyIDictionary<String, BufferedReader> fileTbl, MyIHeap heapTbl, MyLatchTable latchTable, IStmt prg) {
        exeStack = stack;
        symbolTable = symTbl;
        outTable = outTbl;
        fileTable = fileTbl;
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String, Value> symTbl, MyIList<Value> outTbl,
                    MyIDictionary<String, BufferedReader> fileTbl, MyIHeap heapTbl, MyILatchTable latchTable) {
        exeStack = stack;
        symbolTable = symTbl;
        outTable = outTbl;
        fileTable = fileTbl;
    ...
    public String latchTableToString() throws ADTException {
        ...
        for (int key : latchTable.getLatchTable().keySet()) {
            latchStringBuilder.append(String.format("%d -> %s\n", key, latchTable.get(key)));
        }
    ...
    public String toString() {
        return "\nProgram id: " + getId() + "\nExecution stack: " + this.exeStack.getReversed() + "\nSymbol table: " + this.symbolTable.toString()
                ...
                + "\nHeap: " + this.heap.toString() + "\nLatch table: " + this.latchTable.toString();
    }
