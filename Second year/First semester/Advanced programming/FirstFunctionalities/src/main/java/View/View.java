...
public class View {
    ...
    private void runProgram1(int display) throws StatementException, ExpressionException, ADTException, IOException, InterruptedException {
    ...
    private void runProgram2(int display) throws StatementException, ExpressionException, ADTException, IOException, InterruptedException {
    ...
    private void runProgram3(int display) throws StatementException, ExpressionException, ADTException, IOException, InterruptedException {
    ...
    private void runProgram4(int display) throws StatementException, ExpressionException, ADTException, IOException, InterruptedException {
    ...
    private void runProgram5(int display) throws StatementException, ExpressionException, ADTException, IOException, InterruptedException {
    ...
    private void runStatement(IStmt statement, int display) throws StatementException, ExpressionException, ADTException, IOException, InterruptedException {
    ...
    public void executeInput() {
        ...
        while (true) {
            try {
                ...
                if (command == 5)
                    runProgram5(display);
            } catch (StatementException | ExpressionException | ADTException | IOException | InterruptedException e) {
