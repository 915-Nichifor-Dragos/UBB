...
public class ExecutorProgramController {
    ...
    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> locationColumnLatch;

    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> valueColumnLatch;
    ...
    public void initialize() {
        ...
        locationColumnLatch.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().first).asObject());
        valueColumnLatch.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().second).asObject());
    }
