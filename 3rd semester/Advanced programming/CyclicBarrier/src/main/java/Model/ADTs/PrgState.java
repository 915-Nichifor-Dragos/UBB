...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String, Value> symTbl, MyIList<Value> outTbl,
                    MyIDictionary<String, BufferedReader> fileTbl, MyIHeap heapTbl, MyIBarrierTable barrierTable, IStmt prg) {
        exeStack = stack;
        symbolTable = symTbl;
        outTable = outTbl;
        fileTable = fileTbl;
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String, Value> symTbl, MyIList<Value> outTbl,
                    MyIDictionary<String, BufferedReader> fileTbl, MyIHeap heapTbl, MyIBarrierTable barrierTable) {
        exeStack = stack;
        symbolTable = symTbl;
        outTable = outTbl;
        fileTable = fileTbl;
