...
public class ExecutorProgramController {
    ...
    @FXML
    private TableView<Map.Entry<Integer, javafx.util.Pair<Integer, List<Integer>>>> tableViewSemaphore;

    @FXML
    private TableColumn<Map.Entry<Integer, javafx.util.Pair<Integer, List<Integer>>>, Integer> indexColumnSemaphore;

    @FXML
    private TableColumn<Map.Entry<Integer, javafx.util.Pair<Integer, List<Integer>>>, Integer> valueColumnSemaphore;

    @FXML
    private TableColumn<Map.Entry<Integer, javafx.util.Pair<Integer, List<Integer>>>, List<Integer>> listColumnSemaphore;
    ...
    public void initialize() {
        ...
        indexColumnSemaphore.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getKey()).asObject());
        valueColumnSemaphore.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getValue().getKey()).asObject());
        listColumnSemaphore.setCellValueFactory(p -> new SimpleObjectProperty<>(p.getValue().getValue().getValue()));
    }
    ...
    private void populateSemaphoreTableView() {
        ...
        tableViewSemaphore.setItems(FXCollections.observableArrayList(semaphoreList));
        tableViewSemaphore.refresh();
    }
