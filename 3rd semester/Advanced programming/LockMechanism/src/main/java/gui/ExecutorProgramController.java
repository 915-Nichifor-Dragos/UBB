...
public class ExecutorProgramController {
    ...
    @FXML
    private TableColumn<Pair<Integer, Integer>, String> locationLockColumn;

    @FXML
    private TableColumn<Pair<Integer, Integer>, String> valueLockColumn;
    ...
    public void initialize() {
        ...
        locationLockColumn.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().first.toString()));
        valueLockColumn.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().second.toString()));
    }
