...
public class ExecutorProgramController {
    ...
    @FXML
    private TableColumn<Map.Entry<String, javafx.util.Pair<List<String>, IStmt>>, javafx.util.Pair<String, List<String>>> signatureColumnProcedure;

    @FXML
    private TableColumn<Map.Entry<String, javafx.util.Pair<List<String>, IStmt>>, String> bodyColumnProcedure;
    ...
    public void initialize() {
        ...
        signatureColumnProcedure.setCellValueFactory(p -> new SimpleObjectProperty<>(new javafx.util.Pair<String, List<String>>(p.getValue().getKey(), p.getValue().getValue().getKey())));
        bodyColumnProcedure.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getValue().getValue().toString()));
    }
